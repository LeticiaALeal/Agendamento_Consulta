...
namespace LeBi
{
    public partial class ConsultaPaciente : Form
    {
        ...
        private void ConsultaPaciente_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                string cmd = "select id as 'Código', medico as 'Médico', especialidade as 'Especialidade', horario as 'Horário', dia as 'Dia' from consulta_paciente where email = '" + paciente + "'";
